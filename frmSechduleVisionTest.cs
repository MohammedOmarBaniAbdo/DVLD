...
namespace DVLD1
{
    public partial class frmSechduleVisionTest : Form
    {
        ...
        public frmSechduleVisionTest(int dLID, string className)
        {
            InitializeComponent();
        ...
        private void frmSechduleVisionTest_Load(object sender, EventArgs e)
        {
            ...
            ctrlAddAppointments1.lbPassedTest = "0/3";
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
           ...
           LocalDrivingLicenseApplicationID, 1))
            ...
            frmVisionTest frm = new frmVisionTest(-1, LocalDrivingLicenseApplicationID, 1);
            // 1 => Vision Test
            // 2 => Written Test
            // 3 => Street Test
            frm.ShowDialog();
        ...
        private void Edit_Click(object sender, EventArgs e)
        {
            ...
            frmVisionTest frm = new frmVisionTest(Convert.ToInt32(dgvAppointment.CurrentRow.Cells[0].Value), LocalDrivingLicenseApplicationID, 1);
        ...
        private void TakeTest_Click(object sender, EventArgs e)
        {
            ...
            frmTakeTest frm = new frmTakeTest(Convert.ToInt32(dgvAppointment.CurrentRow.Cells[0].Value), LocalDrivingLicenseApplicationID, 1);
            frm.ShowDialog();
            _Ref();
        }
    }
