...
namespace DVLD1
{
    public partial class frmSechduleStreetTest : Form
    {
        ...
        BLLTests test;
        public frmSechduleStreetTest(int dLID, string className)
        {
            InitializeComponent();
        ...
        private void pictureBox2_Click(object sender, EventArgs e)
        {
           ...
           LocalDrivingLicenseApplicationID, 3))
            ...
            frmVisionTest frm = new frmVisionTest(-1, LocalDrivingLicenseApplicationID, 3);
            // 1 => Vision Test
            // 2 => Written Test
            // 3 => Street Test
            frm.ShowDialog();
        ...
        private void TakeTest_Click(object sender, EventArgs e)
        {
            ...
            frmTakeTest frm = new frmTakeTest(Convert.ToInt32(dgvAppointment.CurrentRow.Cells[0].Value), LocalDrivingLicenseApplicationID, 3);
            frm.ShowDialog();
            _Ref();
        }
        ...
        private void Edit_Click(object sender, EventArgs e)
        {
            ...
            frmVisionTest frm = new frmVisionTest(Convert.ToInt32(dgvAppointment.CurrentRow.Cells[0].Value), LocalDrivingLicenseApplicationID, 3);
            frm.GroubBoxEnabled = false;
            frm.ShowDialog();
            _Ref();
        }

        private void frmSechduleStreetTest_Load(object sender, EventArgs e)
        {
            ctrlAddAppointments1.LoadDataGroubBox1ANDGB2(LocalDrivingLicenseApplicationID, ClassName, PassRes);
            ctrlAddAppointments1.lbPassedTest = "2/3";
